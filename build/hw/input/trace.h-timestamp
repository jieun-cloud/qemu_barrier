...
static inline void _nocheck__trace_adb_kbd_no_key(void)
{
    if (trace_event_get_state(TRACE_ADB_KBD_NO_KEY) && qemu_loglevel_mask(LOG_TRACE)) {
        ...
        qemu_log("%d@%zd.%06zd:adb_kbd_no_key " "Ignoring NO_KEY" "\n",
                 getpid(),
...
static inline void _nocheck__trace_adb_kbd_writereg(int reg, uint8_t val)
{
    if (trace_event_get_state(TRACE_ADB_KBD_WRITEREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_kbd_writereg " "reg %d val 0x%2.2x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val);
    }
...
static inline void _nocheck__trace_adb_kbd_readreg(int reg, uint8_t val0, uint8_t val1)
{
    if (trace_event_get_state(TRACE_ADB_KBD_READREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_kbd_readreg " "reg %d obuf[0] 0x%2.2x obuf[1] 0x%2.2x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val0, val1);
    }
...
static inline void _nocheck__trace_adb_kbd_request_change_addr(int devaddr)
{
    if (trace_event_get_state(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_kbd_request_change_addr " "change addr to 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr);
    }
...
static inline void _nocheck__trace_adb_kbd_request_change_addr_and_handler(int devaddr, int handler)
{
    if (trace_event_get_state(TRACE_ADB_KBD_REQUEST_CHANGE_ADDR_AND_HANDLER) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_kbd_request_change_addr_and_handler " "change addr and handler to 0x%x, 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr, handler);
    }
...
static inline void _nocheck__trace_adb_mouse_flush(void)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_FLUSH) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_mouse_flush " "flush" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_adb_mouse_writereg(int reg, uint8_t val)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_WRITEREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_mouse_writereg " "reg %d val 0x%2.2x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val);
    }
...
static inline void _nocheck__trace_adb_mouse_readreg(int reg, uint8_t val0, uint8_t val1)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_READREG) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_mouse_readreg " "reg %d obuf[0] 0x%2.2x obuf[1] 0x%2.2x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , reg, val0, val1);
    }
...
static inline void _nocheck__trace_adb_mouse_request_change_addr(int devaddr)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_mouse_request_change_addr " "change addr to 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr);
    }
...
static inline void _nocheck__trace_adb_mouse_request_change_addr_and_handler(int devaddr, int handler)
{
    if (trace_event_get_state(TRACE_ADB_MOUSE_REQUEST_CHANGE_ADDR_AND_HANDLER) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:adb_mouse_request_change_addr_and_handler " "change addr and handler to 0x%x, 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , devaddr, handler);
    }
...
static inline void _nocheck__trace_ps2_put_keycode(void * opaque, int keycode)
{
    if (trace_event_get_state(TRACE_PS2_PUT_KEYCODE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_put_keycode " "%p keycode 0x%02x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, keycode);
    }
...
static inline void _nocheck__trace_ps2_keyboard_event(void * opaque, int qcode, int down, unsigned int modifier, unsigned int modifiers)
{
    if (trace_event_get_state(TRACE_PS2_KEYBOARD_EVENT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_keyboard_event " "%p qcode %d down %d modifier 0x%x modifiers 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_ps2_read_data(void * opaque)
{
    if (trace_event_get_state(TRACE_PS2_READ_DATA) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_read_data " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque);
    }
...
static inline void _nocheck__trace_ps2_set_ledstate(void * s, int ledstate)
{
    if (trace_event_get_state(TRACE_PS2_SET_LEDSTATE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_set_ledstate " "%p ledstate %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s, ledstate);
    }
...
static inline void _nocheck__trace_ps2_reset_keyboard(void * s)
{
    if (trace_event_get_state(TRACE_PS2_RESET_KEYBOARD) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_reset_keyboard " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s);
    }
...
static inline void _nocheck__trace_ps2_write_keyboard(void * opaque, int val)
{
    if (trace_event_get_state(TRACE_PS2_WRITE_KEYBOARD) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_write_keyboard " "%p val %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, val);
    }
...
static inline void _nocheck__trace_ps2_keyboard_set_translation(void * opaque, int mode)
{
    if (trace_event_get_state(TRACE_PS2_KEYBOARD_SET_TRANSLATION) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_keyboard_set_translation " "%p mode %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, mode);
    }
...
static inline void _nocheck__trace_ps2_mouse_send_packet(void * s, int dx1, int dy1, int dz1, int b)
{
    if (trace_event_get_state(TRACE_PS2_MOUSE_SEND_PACKET) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_mouse_send_packet " "%p x %d y %d z %d bs 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s, dx1, dy1, dz1, b);
    }
...
static inline void _nocheck__trace_ps2_mouse_fake_event(void * opaque)
{
    if (trace_event_get_state(TRACE_PS2_MOUSE_FAKE_EVENT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_mouse_fake_event " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque);
    }
...
static inline void _nocheck__trace_ps2_write_mouse(void * opaque, int val)
{
    if (trace_event_get_state(TRACE_PS2_WRITE_MOUSE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_write_mouse " "%p val %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, val);
    }
...
static inline void _nocheck__trace_ps2_kbd_reset(void * opaque)
{
    if (trace_event_get_state(TRACE_PS2_KBD_RESET) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_kbd_reset " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque);
    }
...
static inline void _nocheck__trace_ps2_mouse_reset(void * opaque)
{
    if (trace_event_get_state(TRACE_PS2_MOUSE_RESET) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_mouse_reset " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque);
    }
...
static inline void _nocheck__trace_ps2_kbd_init(void * s)
{
    if (trace_event_get_state(TRACE_PS2_KBD_INIT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_kbd_init " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s);
    }
...
static inline void _nocheck__trace_ps2_mouse_init(void * s)
{
    if (trace_event_get_state(TRACE_PS2_MOUSE_INIT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:ps2_mouse_init " "%p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , s);
    }
...
static inline void _nocheck__trace_milkymist_softusb_memory_read(uint32_t addr, uint32_t value)
{
    if (trace_event_get_state(TRACE_MILKYMIST_SOFTUSB_MEMORY_READ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:milkymist_softusb_memory_read " "addr 0x%08x value 0x%08x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, value);
    }
...
static inline void _nocheck__trace_milkymist_softusb_memory_write(uint32_t addr, uint32_t value)
{
    if (trace_event_get_state(TRACE_MILKYMIST_SOFTUSB_MEMORY_WRITE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:milkymist_softusb_memory_write " "addr 0x%08x value 0x%08x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, value);
    }
...
static inline void _nocheck__trace_milkymist_softusb_mevt(uint8_t m)
{
    if (trace_event_get_state(TRACE_MILKYMIST_SOFTUSB_MEVT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:milkymist_softusb_mevt " "m %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , m);
    }
...
static inline void _nocheck__trace_milkymist_softusb_kevt(uint8_t m)
{
    if (trace_event_get_state(TRACE_MILKYMIST_SOFTUSB_KEVT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:milkymist_softusb_kevt " "m %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , m);
    }
...
static inline void _nocheck__trace_milkymist_softusb_pulse_irq(void)
{
    if (trace_event_get_state(TRACE_MILKYMIST_SOFTUSB_PULSE_IRQ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:milkymist_softusb_pulse_irq " "Pulse IRQ" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_hid_kbd_queue_full(void)
{
    if (trace_event_get_state(TRACE_HID_KBD_QUEUE_FULL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:hid_kbd_queue_full " "queue full" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_hid_kbd_queue_empty(void)
{
    if (trace_event_get_state(TRACE_HID_KBD_QUEUE_EMPTY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:hid_kbd_queue_empty " "queue empty" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_virtio_input_queue_full(void)
{
    if (trace_event_get_state(TRACE_VIRTIO_INPUT_QUEUE_FULL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zd.%06zd:virtio_input_queue_full " "queue full" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
